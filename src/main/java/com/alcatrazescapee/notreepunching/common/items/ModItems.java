...
public final class ModItems
{
    ...
    public static final RegistryHolder<TieredItem> FLINT_PICKAXE = register("flint_pickaxe", () -> new PickaxeItem(ModTiers.FLINT, new Item.Properties().attributes(DiggerItem.createAttributes(ModTiers.FLINT, 1, -2.8f))) {});
    public static final RegistryHolder<TieredItem> FLINT_HOE = register("flint_hoe", () -> new HoeItem(ModTiers.FLINT, new Item.Properties().attributes(DiggerItem.createAttributes(ModTiers.FLINT, 0, -3.0f))) {});
    public static final RegistryHolder<TieredItem> FLINT_SHOVEL = register("flint_shovel", () -> new ShovelItem(ModTiers.FLINT, new Item.Properties().attributes(DiggerItem.createAttributes(ModTiers.FLINT, -1.0f, -3.0f))));
    public static final RegistryHolder<SwordItem> MACUAHUITL = register("macuahuitl", () -> new SwordItem(ModTiers.FLINT, new Item.Properties().attributes(SwordItem.createAttributes(ModTiers.FLINT, 3, -2.4f))));
    ...
    {
        return new AxeItem(tier, properties.attributes(DiggerItem.createAttributes(tier, attackDamage, attackSpeed))) {};
    }
