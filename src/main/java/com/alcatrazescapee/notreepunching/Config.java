...
public enum Config
{
    ...
    Config()
    {
        ...
        potteryBlockSequences = builder
            ...
            .define("potteryBlockSequences", List.<Block>of(
                Blocks.CLAY,
                ...
                list -> list.stream().map(name -> ParseError.requireNotNull(() -> BuiltInRegistries.BLOCK.getOptional(ResourceLocation.parse(name)).orElse(null), "Invalid block: '%s'".formatted(name))).toList(),
