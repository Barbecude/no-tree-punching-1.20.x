...
public final class Helpers
{
    ...
    {
        return ResourceLocation.fromNamespaceAndPath(NoTreePunching.MOD_ID, path);
    }
    ...
    /**
     * A simplification of {@link ItemStack#hurtAndBreak(int, LivingEntity, EquipmentSlot)} that does not require an entity
     */
    public static ItemStack hurtAndBreak(ItemStack stack, int amount)
    {
        if (stack.isDamageableItem())
        {
            final int newDamage = stack.getDamageValue() + amount;
    ...
    /**
     * Copy pasta from {@link net.minecraft.world.level.block.ShulkerBoxBlock#appendHoverText(ItemStack, net.minecraft.world.item.Item.TooltipContext, List, net.minecraft.world.item.TooltipFlag)}
     */
